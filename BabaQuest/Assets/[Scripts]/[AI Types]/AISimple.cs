    ...
    class AISimple : MonoBehaviour, AITypeInterface
    {
        ...
        private void CheckAttack(CharacterTypeInterface character, int[] possitions, bool myAlignment, bool[] good, int action)
        {
            ...
            for (int j = 0; j < 7; j++) // itterating through tiles
            {
                ...
                {
                    if(good[i] != myAlignment && possitions[j] == i) // is it against me and is he standing on this tile?
                    {
            ...
            else // walk for mage
            {
                ...
                {
                    if (good[i] != myAlignment && i == 0) // is it against me and is he standing on this tile?
                    {
                        t0 = false;
                    }
                    if (good[i] != myAlignment && i == 3) // is it against me and is he standing on this tile?
                    {
                        t3 = false;
                    }
                    if (good[i] != myAlignment && i == 6) // is it against me and is he standing on this tile?
                    {
                        t6 = false;
                    }
                }
